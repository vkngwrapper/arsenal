...
func (a *VulkanAllocator) calcAllocationParams(
	...
	if o.Usage == vam.MemoryUsageAuto || o.Usage == vam.MemoryUsageAutoPreferDevice || o.Usage == vam.MemoryUsageAutoPreferHost {
	...
	if requiresDedicatedAllocation || o.Usage == vam.MemoryUsageGPULazilyAllocated {
...
func (a *VulkanAllocator) findMemoryPreferences(
	...
	switch o.Usage {
	case vam.MemoryUsageGPULazilyAllocated:
		requiredFlags |= core1_0.MemoryPropertyLazilyAllocated
		break
	case vam.MemoryUsageAuto, vam.MemoryUsageAutoPreferDevice, vam.MemoryUsageAutoPreferHost:
		{
			...
			preferDevice := o.Usage == vam.MemoryUsageAutoPreferDevice
			preferHost := o.Usage == vam.MemoryUsageAutoPreferHost
...
func (a *VulkanAllocator) calculateMemoryTypeParameters(
	options *vam.AllocationCreateInfo,
	memoryTypeIndex int,
	size int,
	allocationCount int,
) (common.VkResult, error) {
...
func (a *VulkanAllocator) allocateMemoryOfType(
	...
	dedicatedBufferUsage core1_0.BufferUsageFlags,
	dedicatedImage core1_0.Image,
	createInfo vam.AllocationCreateInfo,
	memoryTypeIndex int,
	suballocationType metadata.SuballocationType,
	dedicatedAllocations *dedicatedAllocationList,
...
func (a *VulkanAllocator) AllocateMemory(memoryRequirements core1_0.MemoryRequirements, o vam.AllocationCreateInfo, outAlloc *Allocation) (common.VkResult, error) {
