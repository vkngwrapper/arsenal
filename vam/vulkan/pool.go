...
func NewPool(allocator *VulkanAllocator, createInfo vam.PoolCreateInfo, preferredBlockSize int) *VulkanPool {
	pool := &VulkanPool{}
	...
	if createInfo.Flags&vam.PoolCreateIgnoreBufferImageGranularity == 0 {
	...
	pool.blockList.Init(
		...
		createInfo.Flags&vam.PoolCreateAlgorithmMask,
		createInfo.Priority,
		alignment,
...
func (p *VulkanPool) unregisterDedicatedAllocation(alloc *Allocation) {
